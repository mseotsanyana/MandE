...
@Keep
public class cImpactBodyView$cExpandableViewBinder extends cExpandableViewBinder<cImpactBodyView, View> {
  public cImpactBodyView$cExpandableViewBinder(cImpactBodyView resolver) {
    super(resolver, R.layout.cImpactBodyView, false, false, false);
  }
  ...
  @Override
  protected void bindViews(cImpactBodyView resolver, View itemView) {
  ...
  @Override
  protected void bindClick(final cImpactBodyView resolver, View itemView) {
  ...
  @Override
  protected void bindLongClick(final cImpactBodyView resolver, View itemView) {
  }
  ...
  @Override
  protected void bindToggle(final cImpactBodyView resolver, View itemView) {
  ...
  @Override
  protected void bindExpand(cImpactBodyView resolver) {
  }

  @Override
  protected void bindCollapse(cImpactBodyView resolver) {
  }
}
