...
public class cQuestionFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private cQuestionFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private cQuestionFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static cQuestionFragmentArgs fromBundle(@NonNull Bundle bundle) {
    cQuestionFragmentArgs __result = new cQuestionFragmentArgs();
    bundle.setClassLoader(cQuestionFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    cQuestionFragmentArgs that = (cQuestionFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(cQuestionFragmentArgs original) {
    ...
    @NonNull
    public cQuestionFragmentArgs build() {
      cQuestionFragmentArgs result = new cQuestionFragmentArgs(arguments);
      return result;
    }
