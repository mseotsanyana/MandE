...
public class cImpactFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private cImpactFragmentArgs() {
  }

  private cImpactFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static cImpactFragmentArgs fromBundle(@NonNull Bundle bundle) {
    cImpactFragmentArgs __result = new cImpactFragmentArgs();
    bundle.setClassLoader(cImpactFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    cImpactFragmentArgs that = (cImpactFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(cImpactFragmentArgs original) {
    ...
    @NonNull
    public cImpactFragmentArgs build() {
      cImpactFragmentArgs result = new cImpactFragmentArgs(arguments);
      return result;
    }
