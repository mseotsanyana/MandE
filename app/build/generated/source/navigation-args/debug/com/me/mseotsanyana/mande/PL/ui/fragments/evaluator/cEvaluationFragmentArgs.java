...
public class cEvaluationFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private cEvaluationFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private cEvaluationFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static cEvaluationFragmentArgs fromBundle(@NonNull Bundle bundle) {
    cEvaluationFragmentArgs __result = new cEvaluationFragmentArgs();
    bundle.setClassLoader(cEvaluationFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    cEvaluationFragmentArgs that = (cEvaluationFragmentArgs) object;
  ...
  public String toString() {
    return "cEvaluationFragmentArgs{"
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(cEvaluationFragmentArgs original) {
    ...
    @NonNull
    public cEvaluationFragmentArgs build() {
      cEvaluationFragmentArgs result = new cEvaluationFragmentArgs(arguments);
      return result;
    }
