...
public class cAWPBFragment extends Fragment {
    private static String TAG = cAWPBFragment.class.getSimpleName();

    private Toolbar toolBar;

    private cAWPBFragment(){
    ...
    public cAWPBFragment newInstance() {
        cAWPBFragment fragment = new cAWPBFragment();
        return fragment;
    }
