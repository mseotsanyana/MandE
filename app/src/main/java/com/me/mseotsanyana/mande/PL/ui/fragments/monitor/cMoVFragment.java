...
public class cMoVFragment extends Fragment {
    private static String TAG = cMoVFragment.class.getSimpleName();
    ...
    public cMoVFragment newInstance() {
        cMoVFragment fragment = new cMoVFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.mov_list_fragment, parent, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        toolBar.setTitle(R.string.mov_list_title);
