...
public class cNotificationRepositoryImpl {
    private static SimpleDateFormat sdf = cConstant.FORMAT_DATE;
    private static String TAG = cNotificationRepositoryImpl.class.getSimpleName();

    // an object of the database helper
    private cSQLDBHelper dbHelper;
    private cEntityRepositoryImpl entityDBA;

    public cNotificationRepositoryImpl(Context context) {
