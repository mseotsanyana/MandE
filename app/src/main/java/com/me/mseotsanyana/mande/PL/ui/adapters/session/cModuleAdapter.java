...
public class cModuleAdapter extends cTreeAdapter implements iViewPermissionListener, Filterable {
    private static final String TAG = cModuleAdapter.class.getSimpleName();
//    private static final SimpleDateFormat sdf = cConstant.SHORT_FORMAT_DATE;
    ...
    private final iModulePresenter.View iModulePresenterView;


    public cModuleAdapter(Context context, iModulePresenter.View iModulePresenterView,
                          List<cTreeModel> moduleTree) {
        super(context, moduleTree);
        this.context = context;
        this.filteredModuleTree = moduleTree;

        this.iModulePresenterView = iModulePresenterView;
    }
    ...
    public void onClickUpdatePermission(List<cNode> nodes) {
        this.iModulePresenterView.onClickUpdatePermission(nodes);
    }
