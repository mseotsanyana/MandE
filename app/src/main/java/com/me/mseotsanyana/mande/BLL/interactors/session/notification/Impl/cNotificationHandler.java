package com.me.mseotsanyana.mande.BLL.interactors.session.notification.Impl;
...
public class cNotificationHandler  {
    ...
    public cNotificationHandler(Context context) {
        //roleDBA = new cNotificationRepositoryImpl(context);
