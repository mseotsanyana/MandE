...
public class cPermissionHandler extends cMapper<cPermissionModel, cPermissionDomain> {
    ...
    public cPermissionHandler(Context context) {
        ...
        operationBITS = 0;//session.loadOperationBITS(cSessionManager.PRIVILEGE,cSessionManager.types[0]);
    }
    ...
    public ArrayList<cPermissionDomain> getPrivilegeList(int userID, int orgID,
        ...
        int privilegeOpsStatusBITS = 0;//session.loadStatusBITS(cSessionManager.PRIVILEGE, cSessionManager.types[0]);
