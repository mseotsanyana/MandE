...
public class cRiskFragment extends Fragment {
    private static String TAG = cRiskFragment.class.getSimpleName();
    ...
    public cRiskFragment newInstance() {
        cRiskFragment fragment = new cRiskFragment();
        return fragment;
    }
