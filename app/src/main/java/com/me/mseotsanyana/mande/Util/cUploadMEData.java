...
public class cUploadMEData {
    ...
    public cUploadMEData(Context context, cSessionManager session){
        ...
        goalHandler = new cGoalHandler(context);
        specificAimHandler = new cSpecificAimHandler(context);
        projectHandler = new cProjectHandler(context);
        objectiveHandler = new cObjectiveHandler(context);
        outcomeHandler = new cOutcomeHandler(context);
        outputHandler = new cOutputHandler(context);
        activityHandler = new cActivityHandler(context);
