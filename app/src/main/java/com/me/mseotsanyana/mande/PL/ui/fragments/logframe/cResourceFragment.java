...
public class cResourceFragment extends Fragment {
    /*
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_resource_list, parent, false);
    }
    ...
    private void initFab(View view) {
        view.findViewById(R.id.resource_fab).setOnClickListener(new View.OnClickListener() {
            @Override
