...
public class cIndicatorFragment extends Fragment {
    private static String TAG = cIndicatorFragment.class.getSimpleName();
    ...
    public cIndicatorFragment newInstance() {
        cIndicatorFragment fragment = new cIndicatorFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.indicator_list_fragment, parent, false);
    }
