...
public class cArrayChoiceSetModel {
    ...
    public cArrayChoiceSetModel(int choiceSetID, int serverID, int ownerID, int orgID,
    ...
    public void setChoiceSetID(int choiceSetID) {
        this.choiceSetID = choiceSetID;
    }
