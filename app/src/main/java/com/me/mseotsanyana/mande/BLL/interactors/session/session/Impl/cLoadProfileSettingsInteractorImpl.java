...
public class cLoadProfileSettingsInteractorImpl extends cAbstractInteractor
        implements iHomePageInteractor {
    private static final String TAG = cLoadProfileSettingsInteractorImpl.class.getSimpleName();
    ...
    public cLoadProfileSettingsInteractorImpl(iExecutor threadExecutor, iMainThread mainThread, Callback callback,
                                              iSharedPreferenceRepository sharedPreferenceRepository,
                                              iUserProfileAndMenuItemsRepository userProfileAndMenuItemsRepository) {
        super(threadExecutor, mainThread);

        if (sharedPreferenceRepository == null || userProfileAndMenuItemsRepository == null || callback == null) {
    ...
    public void run() {
        ...
        this.userProfileAndMenuItemsRepository.updateHomePageModels(userServerID, organizationServerID,
                primaryTeamBIT, secondaryTeamBITS, teamEntitypermBITS, teamStatuses, teamUnixpermBITS,
                new iUserProfileAndMenuItemsRepository.iUserProfileAndMenuItemsCallback() {
                    @Override
