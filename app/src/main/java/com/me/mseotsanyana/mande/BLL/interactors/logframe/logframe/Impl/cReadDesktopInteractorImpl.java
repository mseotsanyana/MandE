...
public class cReadDesktopInteractorImpl extends cAbstractInteractor
        implements iReadLogFrameInteractor {
    private static String TAG = cReadDesktopInteractorImpl.class.getSimpleName();
    ...
    public cReadDesktopInteractorImpl(iExecutor threadExecutor, iMainThread mainThread,
    ...
    public void run() {
        if (((operationMenuBITS & operationLogFrameBITS & cBitwise.READ) != 0)) {
            ...
            if (menuModelSet != null && logFrameModelSet != null) {
                ...
                Gson gson = new Gson();
                Log.d(TAG, "LOGFRAME = "+gson.toJson(logFrameTreeModels));
