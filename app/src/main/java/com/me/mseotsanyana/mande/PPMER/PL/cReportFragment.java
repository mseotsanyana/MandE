...
public class cReportFragment extends Fragment {
    /*
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_report_list, parent, false);
    }
    ...
    private void initFab(View view) {
        view.findViewById(R.id.report_fab).setOnClickListener(new View.OnClickListener() {
            @Override
