...
public class cWorkplanFragment extends Fragment {
    /*
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_workplan_list, parent, false);
    }
    ...
    private void initFab(View view) {
        //view.findViewById(R.id.workplan_fab).setOnClickListener(new View.OnClickListener() {
        //    @Override
