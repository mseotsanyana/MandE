...
public class cBudgetFragment extends Fragment {
    /*
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_budget_list, parent, false);
    }
    ...
    private void initFab(View view) {
        view.findViewById(R.id.budget_fab).setOnClickListener(new View.OnClickListener() {
            @Override
