...
import com.me.mseotsanyana.mande.BRBAC.BLL.cSessionRoleDomain;
...
import com.me.mseotsanyana.mande.BRBAC.BLL.cMenuRoleDomain;
...
import com.me.mseotsanyana.mande.BRBAC.BLL.cUserRoleDomain;
...
public class cSetDomainsFromExcel {
    ...
    public cOrganizationDomain getOrganizationFromExcel(Row cRow){
        ...
        organizationDomain.setOrganizationName(cRow.getCell(1, Row.CREATE_NULL_AS_BLANK).getStringCellValue());
        organizationDomain.setPhysicalAddress(cRow.getCell(2, Row.CREATE_NULL_AS_BLANK).getStringCellValue());
        organizationDomain.setTelephone(cRow.getCell(3, Row.CREATE_NULL_AS_BLANK).getStringCellValue());
        ...
        organizationDomain.setEmailAddress(cRow.getCell(7, Row.CREATE_NULL_AS_BLANK).getStringCellValue());
