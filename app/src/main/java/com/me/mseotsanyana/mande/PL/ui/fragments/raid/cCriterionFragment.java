...
public class cCriterionFragment extends Fragment {
    /*
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_criterion_list, parent, false);
    }
    ...
    private void initFab(View view) {
        view.findViewById(R.id.criterion_fab).setOnClickListener(new View.OnClickListener() {
            @Override
