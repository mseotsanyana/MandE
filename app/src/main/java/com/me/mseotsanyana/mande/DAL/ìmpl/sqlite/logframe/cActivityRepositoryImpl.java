...
//        cv.put(cSQLDBHelper.KEY_ID, activityModel.getComponentID());
...
////                    activity.setLogFrameModel(getLogFrameModelByID(
////                            activity.getLogFrameModel().getLogFrameID(), userID,
////                            primaryRoleBITS, secondaryRoleBITS, statusBITS));
//                    /* populate an output object */
//                    activity.setOutputModel(getOutputModelByID(
//                            activity.getOutputModel().getComponentID(), userID,
//                            primaryRoleBITS, secondaryRoleBITS, statusBITS));
...
//    private cResourceTypeModel getResourceModelByID(long resourceTypeID, long userID,
//                                                    int primaryRoleBITS, int secondaryRoleBITS,
//                                                    int statusBITS) {
//
//        // open the connection to the database
...
//                String.valueOf(statusBITS)});     /* access due to assigned statuses */
//
//        cResourceTypeModel resource = new cResourceTypeModel();
//
//        try {
//            if (cursor.moveToFirst()) {
...
//                        cursor.getString(cursor.getColumnIndex(cSQLDBHelper.KEY_SYNCED_DATE))));
    ...
    private Set<cQuestionModel> getQuestionModelSetByID(long activityPlanningID, long userID,
        ...
        String selectQuery = "SELECT " +
                ...
                //FIXME: cSQLDBHelper.TABLE_tblOUTPUT_QUESTION + " AQ " +
...
//                            cursor.getInt(cursor.getColumnIndex(cSQLDBHelper.KEY_QUESTION_GROUPING_FK_ID)));
    ...
    private Set<cRaidModel> getRaidModelSetByID(long activityPlanningID, long userID,
        ...
        String selectQuery = "SELECT " +
                ...
                //FIXME: cSQLDBHelper.TABLE_tblACTIVITY_RAID + " AR " +
...
//                    output.setComponentID(cursor.getInt(
