package com.me.mseotsanyana.mande.DAL.ìmpl.sqlite.synchronization;

import android.content.Context;

import com.me.mseotsanyana.mande.BLL.repository.synchronization.iSyncSetRepository;
...
public class cSyncEntitySetImpl implements iSyncSetRepository {
    private static SimpleDateFormat sdf = cConstant.FORMAT_DATE;
    private static String TAG = cSyncEntitySetImpl.class.getSimpleName();

    // an object of the database helper
    private cSQLDBHelper dbHelper;
    private Context context;

    public cSyncEntitySetImpl(Context context) {
    ...
    @Override
    public void synchronizeEntitySet(ArrayList entitySet) {
...
//                    Class handler = Class.forName(entitySet.get(i).getEntity().first);
