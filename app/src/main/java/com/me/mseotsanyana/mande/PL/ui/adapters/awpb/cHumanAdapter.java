...
public class cHumanAdapter extends RecyclerView.Adapter<cHumanAdapter.cHumanParentViewHolder>
        implements Filterable {
    private static String TAG = cHumanAdapter.class.getSimpleName();
    ...
    private List<cHumanModel> filteredHumanModels;

    public cHumanAdapter(Context context, iInputPresenter.View inputPresenterView,
                         ArrayList<cHumanModel> humanModels) {
        this.context = context;
        this.humanModels = humanModels;
        this.filteredHumanModels = humanModels;
    ...
    @NonNull
    @Override
    public cHumanParentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.resources_parent_cardview, parent, false);
        return new cHumanParentViewHolder(view);
    }

    public void onBindViewHolder(@NonNull cHumanParentViewHolder HH, int position) {
        cHumanModel humanModel = this.filteredHumanModels.get(position);
    ...
    public int getItemCount() {
        return filteredHumanModels.size();
    }

    public void setHumanModels(ArrayList<cHumanModel> humanModels) {
        this.humanModels = humanModels;
        this.filteredHumanModels = humanModels;
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    filteredHumanModels = humanModels;
                } else {
                ...
                filterResults.count = filteredHumanModels.size();
                filterResults.values = filteredHumanModels;
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ...
                filteredHumanModels = (ArrayList<cHumanModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }

    public static class cHumanParentViewHolder extends RecyclerView.ViewHolder {
        ...
        private cHumanParentViewHolder(final View viewHolder) {
            super(viewHolder);
