...
public class cHumanAdapter extends cTreeAdapter {
        ...
        switch (viewType) {
            case PARENT:
                view = inflater.inflate(R.layout.resources_parent_cardview, parent,
                        false);
                viewHolder = new cHumanParentViewHolder(context, view);
                break;
            case CHILD:
    ...
    public void OnBindTreeViewHolder(RecyclerView.ViewHolder viewHolder, final int position){
        ...
        if (obj != null){
            switch (obj.getType()) {
                case PARENT:
                    cHumanModel humanModel = (cHumanModel) obj.getModelObject();
                    cHumanAdapter.cHumanParentViewHolder HPH =
                            ((cHumanAdapter.cHumanParentViewHolder) viewHolder);
    ...
    public static class cHumanParentViewHolder extends cTreeViewHolder {
        ...
        private cHumanParentViewHolder(Context context, final View treeViewHolder) {
