...
public class cAddressRepositoryImpl implements iAddressRepository {
    private static SimpleDateFormat sdf = cConstant.FORMAT_DATE;
    private static String TAG = cAddressRepositoryImpl.class.getSimpleName();

    // an object of the database helper
    private cSQLDBHelper dbHelper;

    public cAddressRepositoryImpl(Context context) {
