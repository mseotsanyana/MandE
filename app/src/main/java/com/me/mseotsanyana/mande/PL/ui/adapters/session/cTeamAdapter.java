...
public class cTeamAdapter extends cTreeAdapter implements Filterable {
    private static String TAG = cTeamAdapter.class.getSimpleName();
    ...
    public cTeamAdapter(Context context, List<cTreeModel> teamsMembersTree) {
